...
float rectXPic1, rectYPic1, picWidth, picHeight;
float rectXPic2, rectYPic2;
float rectXPic3, rectYPic3;
float rectXPic4, rectYPic4;
float rectXPic5, rectYPic5;
float rectXPic6, rectYPic6;
...
{
  picWidth =  rectWidth;
  picHeight = rectHeight; //Dimension: 800 x 560, width and height
  //
  ...
  pic5 = loadImage("lets-get-started.jpg"); //Dimension: 800 x 560, width and height
  pic6 = loadImage("lets-get-started.jpg"); //Dimension: 800 x 560, width and height
  //
